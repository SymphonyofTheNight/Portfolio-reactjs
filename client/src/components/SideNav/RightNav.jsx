...
const RightNav = () => {
    ...
    return (
        <div className='xs:hidden relative lg:grid h-[35vh] w-[5vw] right-[3.5vw] bottom-0 place-items-center rightnav'>
            <div className={`bg-none absolute border-white rounded
