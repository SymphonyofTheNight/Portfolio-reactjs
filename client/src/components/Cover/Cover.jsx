        ...
        <div className={`cover ${!colortoggle ? 'bg-black/[0.9]' : 'bg-white/[0.9]'} overflow-hidden h-[100vh] w-[100vw] absolute top-0 left-0 z-[30] flex flex-col flex-wrap transition duration-[1s] ease-in-out`} ref={mainref}>
            ...
            <div className='h-[15vh] w-[100vw] flex flex-row flex-wrap relative transition duration-[1s] ease-in-out' ref={botref}>
                <div className='lg:w-[40vw] xs:w-[50vw] md:w-[45vw] h-[15vh] flex items-center justify-center md:text-justify'>
                    <span className={`xl:text-[1.2em] font-Oswald ${!colortoggle ? 'text-white' : 'text-black'} tracking-[7px] mb-[3vh] xl:ml-[1.5vw] lg2:text-base lg2:tracking-[5px] lg1:text-[.9em] lg1:tracking-[4px] lg1:ml-[3vw] lg:text-[.9em] lg:tracking-[3px] md:text-[1.4em] md:ml-[1vw] md:tracking-[3px] md:p-[2em] xs:text-[.7em] sm:text-base xs:tracking-[1px] xs:ml-[7vw] sm:ml-[2vw] xs:mb-[5vh]`}>
                ...
                <div className='w-[40vw] h-[15vh] absolute right-0 flex items-center justify-end'>
                    <div className='xl:mr-[6vw] lg:h-[4vh] lg:w-[auto] lg:mr-[5vw] xs:mr-[8vw] sm:mr-[4vw] md:mr-[3vw] mb-[3vh] xs:mb-[5vh] flex flex-row '>
                        ...
                        <button className='bg-transparent lg:h-[4vh] lg:w-[auto] xs:w-[11vw] sm:w-[auto] grid place-items-center'>
                            <FaGithub className={`xl:text-[2em] mr-[20px] ml-[20px] ${!colortoggle ? 'text-white' : 'text-black'} lg2:text-3xl lg1:text-2xl lg:text-2xl md:text-4xl xs:text-2xl`} />
                        </button>
                        <button className='bg-transparent lg:h-[4vh] lg:w-[auto] xs:w-[11vw] sm:w-[auto] grid place-items-center'>
                            <FaTelegram className={`xl:text-[2em] mr-[20px] ml-[20px] ${!colortoggle ? 'text-white' : 'text-black'} lg2:text-3xl lg1:text-2xl lg:text-2xl md:text-4xl xs:text-2xl`} />
                        </button>
                    </div>
                </div>
            </div>
